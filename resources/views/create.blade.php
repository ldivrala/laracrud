...
<body>
    <div class="container my-2 ">
        <div class="p-5">
            <div class="form">
                <form action="{{ route('crud.store') }}" method="POST" enctype="application/x-www-form-urlencoded">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('email') border border-danger @enderror"
                            name="email" id="email" value="{{ old('email') }}" aria-describedby="emailHelp" placeholder="Enter email">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('mobile') border border-danger @enderror"
                            name="mobile" id="mobile" value="{{ old('mobile') }}" placeholder="Mobile">
                        @error('mobile')
                        <div class="text-danger mx-2 mb-2" role="alert">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('DOB') border border-danger @enderror" name="DOB"
                            id="DOB" value="{{ old('DOB') }}" placeholder="DOB">
                        @error('DOB')
                        <div class="text-danger mx-2 mb-2" role="alert">
                            {{ $message }}
                        </div>
